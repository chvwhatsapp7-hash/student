...
class Hackathon {
  ...
  factory Hackathon.fromApi(Map<String, dynamic> json) {
    ...
    // Assign accent color based on organizer
    final orgColors = {
      'Google': kPrimary,
      ...
      child: Column(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                _statPill('${_hackathons.length}', 'Hackathons'),
