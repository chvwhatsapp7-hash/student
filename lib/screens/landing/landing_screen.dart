...
class _LandingScreenState extends State<LandingScreen>
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              // ── Slides — fills remaining space minus bottom controls
              Expanded(
                child: PageView.builder(
                  ...
                  itemBuilder: (ctx, i) =>
                      _buildSlide(_slides[i], sw, sh, i),
                ),
              ),

              // ── Dot indicators + Skip button
  ...
  Widget _buildSlide(
      _Slide slide, double sw, double sh, int index) {
              ...
              decoration: BoxDecoration(
                gradient: isLast
                  ...
                  begin: Alignment.centerLeft,
                    ...
                    : null,
                color: isLast ? null : Colors.white.withOpacity(0.08),
