...
List<AppNotification> get staticNotifications {
  ...
  return [
    AppNotification(
      id: 's1',
      title: '🏢 New Company Added — Zepto',
      body: 'Zepto is now on StudentHub! They are hiring for SDE Intern, Product, and Data roles. Explore their profile.',
      time: now.subtract(const Duration(minutes: 5)),
      type: 'company', category: 'public',
      redirectTo: 'companies',
    ),
    AppNotification(
      id: 's2',
      title: '📚 New Course Available — DSA Masterclass',
      body: 'A new course "DSA Masterclass for Placements" is now live. 4,200 students enrolled already. Grab your spot!',
      time: now.subtract(const Duration(minutes: 30)),
      type: 'course', category: 'public',
      redirectTo: 'courses',
    ),
    AppNotification(
      id: 's3',
      title: '✅ Application Submitted — Google SWE Intern',
      body: 'Your application for Software Engineer Intern 2025 at Google has been submitted. Application ID: #GG-10293.',
      time: now.subtract(const Duration(hours: 1)),
      type: 'application', category: 'personal',
      redirectTo: 'applications',
    ),
    AppNotification(
      id: 's4',
      title: '🏆 New Hackathon — Smart India 2025',
      body: 'Smart India Hackathon 2025 is now open for registrations. ₹10L prize pool. Team size: 4-6 members.',
      time: now.subtract(const Duration(hours: 3)),
      type: 'hackathon', category: 'public',
      redirectTo: 'hackathons',
    ),
    AppNotification(
      id: 's5',
      title: '🎓 Enrollment Confirmed — System Design',
      body: 'You\'re enrolled in "System Design for Interviews". Start learning now from Day 1 module.',
      time: now.subtract(const Duration(hours: 6)),
      type: 'enrollment', category: 'personal',
      redirectTo: 'courses',
    ),
    AppNotification(
      id: 's6',
      title: '💼 New Internship — Swiggy Data Science',
      body: 'Swiggy posted a 6-month Data Science internship (₹30K/month). 12 applicants so far — apply early!',
      time: now.subtract(const Duration(hours: 10)),
      type: 'internship', category: 'public',
      redirectTo: 'internships',
    ),
    AppNotification(
      id: 's7',
      title: '🏅 Achievement Unlocked — First Application!',
      body: 'You\'ve unlocked the "Go-Getter" badge for submitting your first job application. Keep it up!',
      time: now.subtract(const Duration(days: 1, hours: 2)),
      type: 'achievement', category: 'personal',
      redirectTo: 'achievements',
    ),
    AppNotification(
      id: 's8',
      title: '💼 New Job — Amazon SDE-1',
      body: 'Amazon is hiring SDE-1 in Bangalore. 3+ openings match your profile — 92% fit score.',
      time: now.subtract(const Duration(days: 1, hours: 5)),
      type: 'job', category: 'public',
      redirectTo: 'jobs',
    ),
    AppNotification(
      id: 's9',
      title: '🔖 Course Saved — Flutter Bootcamp',
      body: '"Complete Flutter Bootcamp" has been saved to your library. You can access it anytime from Saved Courses.',
      time: now.subtract(const Duration(days: 2)),
      type: 'saved', category: 'personal',
      redirectTo: 'courses',
    ),
    AppNotification(
      id: 's10',
      title: '🏆 Hackathon Registered — CodeStorm 2025',
      body: 'Your team "ByteBusters" is registered for CodeStorm 2025. Event starts on 15 Feb 2025 at 10 AM.',
      time: now.subtract(const Duration(days: 3)),
      type: 'hackathon', category: 'personal',
      redirectTo: 'hackathons',
    ),
  ];
}
